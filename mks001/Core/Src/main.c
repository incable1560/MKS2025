...
#define BUTTON_DELAY1 40
#define BUTTON_DELAY2 5
/* USER CODE END PD */
...
void button(void)
{
	...
	static uint32_t last_sample2 = 0;
	static uint32_t last_sample1 = 0;

	if (Tick - last_sample2 >= BUTTON_DELAY1) {
	...
	if (Tick - last_sample1 >= BUTTON_DELAY2) {
